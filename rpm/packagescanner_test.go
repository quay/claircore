...
func TestScan(t *testing.T) {
	...
	t.Run("SQLite", func(t *testing.T) {
		...
		// registry.access.redhat.com/ubi9/ubi@sha256:f14f9eb6c5ec6ea9664b54ea8816462e11abc096954d59eac536b64873d908f2
		hash := claircore.MustParseDigest(`sha256:6505b024e539929a1909c8820535221fe70806ce5467b5f30aef8d45a4a97da7`)
		l := claircore.Layer{Hash: hash}
		ctx := zlog.Test(context.Background(), t)
		n, err := fetch.Layer(ctx, t, http.DefaultClient, "registry.access.redhat.com", "ubi9/ubi", hash)
		if err != nil {
			t.Fatal(err)
		}
		defer n.Close()
