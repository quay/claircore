...
func TestV2(t *testing.T) {
	...
	t.Run("Canonical", func(t *testing.T) {
		pairs := [][2]string{
			{"AV:A/AC:L/Au:N/C:C/I:C/A:C/CDP:H/TD:H/CR:H", "AV:A/AC:L/Au:N/C:C/I:C/A:C/CDP:H/TD:H/CR:H/IR:ND/AR:ND"},
			{"AV:A/AC:L/Au:N/C:C/I:C/A:C/E:F", "AV:A/AC:L/Au:N/C:C/I:C/A:C/E:F/RL:ND/RC:ND"},
		}
		Canonical[V2, V2Metric, *V2](t, pairs)
	})
