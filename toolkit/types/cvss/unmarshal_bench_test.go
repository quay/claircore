...
func BenchmarkUnmarshal(b *testing.B) {
	b.Run("V2", benchUnmarshalV2)
	b.Run("V3", benchUnmarshalV3)
	b.Run("V4", benchUnmarshalV4)
}

func benchUnmarshalV4(b *testing.B) {
...
func benchUnmarshalV3(b *testing.B) {
	benchOne := func(b *testing.B, vec []byte) {
		b.Helper()
		b.Attr("input", string(vec))
		var v V3
...
func benchUnmarshalV2(b *testing.B) {
	benchOne := func(b *testing.B, vec []byte) {
		b.Helper()
		b.Attr("input", string(vec))
		var v V2
