# Index Report
An Index Report defines the contents of a container image.
An Index Report can be unpacked into a slice of Index Records which define a package, distribution, repository tuple.
