...
// Source: github.com/quay/claircore/internal/scanner (interfaces: Coalescer)
...
func (m *MockCoalescer) Coalesce(arg0 context.Context, arg1 []*claircore.Layer) (*claircore.ScanReport, error) {
	m.ctrl.T.Helper()
