...
// Source: github.com/quay/claircore/internal/scanner (interfaces: PackageScanner)
...
func (m *MockPackageScanner) Scan(arg0 *claircore.Layer) ([]*claircore.Package, error) {
	m.ctrl.T.Helper()
...
func (mr *MockPackageScannerMockRecorder) Scan(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Scan", reflect.TypeOf((*MockPackageScanner)(nil).Scan), arg0)
}
