...
func Test_GetBuilder_Determinist_Arguments(t *testing.T) {
	var tt = []struct {
		name     string
		matchers []vulnstore.MatchExp
		expected string
	}{
		{
			name:     "expect dist_did",
			matchers: []vulnstore.MatchExp{vulnstore.PackageDistributionDID},
		...
		// 	matchers: []vulnstore.Matcher{vulnstore.PackageDistributionName},
		...
		// 	matchers: []vulnstore.Matcher{vulnstore.PackageDistributionVersion},
		...
		// 	matchers: []vulnstore.Matcher{vulnstore.PackageDistributionVersionCodeName},
		...
		// 	matchers: []vulnstore.Matcher{vulnstore.PackageDistributionVersionID},
		...
		// 	matchers: []vulnstore.Matcher{vulnstore.PackageDistributionArch},
		...
		// 	matchers: []vulnstore.Matcher{vulnstore.PackageDistributionDID, vulnstore.PackageDistributionName},
		...
		// 	matchers: []vulnstore.Matcher{vulnstore.PackageDistributionName, vulnstore.PackageDistributionDID},
		...
		// 	matchers: []vulnstore.Matcher{
		// 		vulnstore.PackageDistributionDID,
		// 		vulnstore.PackageDistributionName,
		// 		vulnstore.PackageDistributionVersion,
		// 	},
