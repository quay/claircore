// Package guestfs provides functionality to inspect arbitrary disk images via
// [libguestfs(3)].
//
// Users should call [Load] as early as possible in initialization to determine
// if needed libraries are present.
//
// [libguestfs(3)]: https://libguestfs.org/guestfs.3.html
package guestfs
...
// Load attempts to dynamically load needed libraries, and reports
// [errors.ErrUnsupported] if unable to.
var Load = sync.OnceValue(doLoad)

// DoLoad attempts to load needed libraries.
func doLoad() error {
	var err loadError
	err.LibC = loadLibC()
	err.LibGuestFS = loadLib()

	if err.LibC == nil && err.LibGuestFS == nil {
		return nil
	}
	return &err
}

// LoadError is returned from [doLoad].
...
func (e *loadError) Error() string {
	...
	multi := e.LibC != nil && e.LibGuestFS != nil
	...
	b.WriteString(": ")
	if e.LibC != nil {
		b.WriteString(e.LibC.Error())
	}
	if multi {
		b.WriteString(", ")
	}
	if e.LibGuestFS != nil {
		b.WriteString(e.LibGuestFS.Error())
	}
...
func (e *loadError) Unwrap() []error {
	errs := make([]error, 0, 2)
	if e.LibC != nil {
		errs = append(errs, e.LibC)
	}
	if e.LibGuestFS != nil {
		errs = append(errs, e.LibGuestFS)
	}
	return errs
}

// Is implements [errors.Is].
func (e *loadError) Is(tgt error) bool {
...
// nastiness.
var lib struct {
	CreateFlags func(int) guestfs // guestfs_create_flags
	Launch      func(guestfs) int // guestfs_launch
	Close       func(guestfs)     // guestfs_close

	LastError        func(guestfs) string                   // guestfs_last_error
	LastErrno        func(guestfs) int                      // guestfs_last_errno
	SetErrorHandler  func(guestfs, uintptr, unsafe.Pointer) // guestfs_set_error_handler
	PushErrorHandler func(guestfs, uintptr, unsafe.Pointer) // guestfs_push_error_handler
	PopErrorHandler  func(guestfs)                          // guestfs_pop_error_handler

	AddDrive func(guestfs, string) int         // guestfs_add_drive
	Mount    func(guestfs, string, string) int // guestfs_mount

	Statns   func(guestfs, string) *guestfsStatns             // guestfs_statns
	Readdir  func(guestfs, string) *guestfsDirentList         // guestfs_readdir
	ReadFile func(guestfs, string, *uint64) *byte             // guestfs_read_file
	PRead    func(guestfs, string, int, int64, *uint64) *byte // guestfs_pread

	FreeStatns     func(*guestfsStatns)     // guestfs_free_statns
	FreeDirentList func(*guestfsDirentList) // guestfs_free_dirent_list
}

// LoadLib reports an error if unable to dynamically load libguestfs.
//
// This should be called before attempting to use [lib].
...
// Guestfs is a [guestfs_h].
//
// [guestfs_h]: https://libguestfs.org/guestfs.3.html#guestfs_h
type guestfs unsafe.Pointer

// GuestfsDirentList is a [guestfs_dirent_list].
//
// [guestfs_dirent_list]: https://libguestfs.org/guestfs.3.html#guestfs_dirent
...
// GuestfsDirent is a [guestfs_dirent].
//
// [guestfs_dirent]: https://libguestfs.org/guestfs.3.html#guestfs_dirent
...
// GuestfsStatns is a [guestfs_statns].
//
// [guestfs_status]: https://libguestfs.org/guestfs.3.html#guestfs_statns1
...
// NewGuestfs creates a guestfs instance via [create_flags] with NO_ENVIRONMENT
// and NO_CLOSE_ON_EXIT, then unsets the error handler.
//
// [create_flags]: https://libguestfs.org/guestfs.3.html#guestfs_create_flags
...
// GetError returns that last error encountered by the [guestfs] instance.
//
// If the last operation did not error, this function reports nil.
//
// The concrete type is [*guesfsErr], if additional introspection is needed.
...
// GuestfsErr is an error reported by a [guestfs] instance.
...
// Call [guestfs_add_drive].
//
// [guestfs_add_drive]: https://libguestfs.org/guestfs.3.html#guestfs_add_drive
...
// Call [guestfs_launch].
//
// [guestfs_launch]: https://libguestfs.org/guestfs.3.html#guestfs_launch
...
// Call [guestfs_mount].
//
// [guestfs_mount]: https://libguestfs.org/guestfs.3.html#guestfs_mount
...
// Pread calls [guestfs_pread], copying the returned data into "dst".
//
// [guestfs_pread]: https://libguestfs.org/guestfs.3.html#guestfs_pread
...
// ReadFile calls [guestfs_read_file] and arranges for the results to be freed
// automatically.
//
// [guestfs_read_file]: https://libguestfs.org/guestfs.3.html#guestfs_read_file
...
func statns(g guestfs, path string) (*fileinfo, error) {
	p := lib.Statns(g, path)
	if p == nil {
		return nil, getError(g)
	}
