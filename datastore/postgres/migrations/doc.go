...
// # Migration Presence
//
// Presence of individual migrations (or interdependent migrations) can be
// thought of as "feature flags:" there should be code to handle both presence
// and absence of the migration. See [IndexerMigrations] and [MatcherMigrations]
