...
//
//	mockgen -package=mock_indexer -destination=./mocks.go github.com/quay/claircore/indexer Store,PackageScanner,VersionedScanner,DistributionScanner,RepositoryScanner,Coalescer,Realizer,FetchArena
//
