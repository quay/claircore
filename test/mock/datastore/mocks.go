...
//
//	mockgen -package=mock_datastore -destination=./mocks.go github.com/quay/claircore/datastore Enrichment,EnrichmentUpdater,MatcherStore,Updater,Vulnerability
//
