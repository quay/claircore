...
// Source: github.com/quay/claircore/updater/driver/v1 (interfaces: Updater,UpdaterFactory,VulnerabilityParser,EnrichmentParser,IndexerMetadataParser)
...
// MockIndexerMetadataParser is a mock of IndexerMetadataParser interface.
type MockIndexerMetadataParser struct {
	ctrl     *gomock.Controller
	recorder *MockIndexerMetadataParserMockRecorder
}

// MockIndexerMetadataParserMockRecorder is the mock recorder for MockIndexerMetadataParser.
type MockIndexerMetadataParserMockRecorder struct {
	mock *MockIndexerMetadataParser
}

// NewMockIndexerMetadataParser creates a new mock instance.
func NewMockIndexerMetadataParser(ctrl *gomock.Controller) *MockIndexerMetadataParser {
	mock := &MockIndexerMetadataParser{ctrl: ctrl}
	mock.recorder = &MockIndexerMetadataParserMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockIndexerMetadataParser) EXPECT() *MockIndexerMetadataParserMockRecorder {
	return m.recorder
}

// ParseIndexerMetadata mocks base method.
func (m *MockIndexerMetadataParser) ParseIndexerMetadata(arg0 context.Context, arg1 fs.FS) (fs.FS, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ParseIndexerMetadata", arg0, arg1)
	ret0, _ := ret[0].(fs.FS)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ParseIndexerMetadata indicates an expected call of ParseIndexerMetadata.
func (mr *MockIndexerMetadataParserMockRecorder) ParseIndexerMetadata(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ParseIndexerMetadata", reflect.TypeOf((*MockIndexerMetadataParser)(nil).ParseIndexerMetadata), arg0, arg1)
}
